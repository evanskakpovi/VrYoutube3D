 ...
 */
public class Floating2DSearch extends CardboardActivity implements CardboardView.StereoRenderer {
    ...
    private static final int MY_PERMISSIONS_REQUEST_READ = 121;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(Floating2DSearch.this,
                Manifest.permission.RECORD_AUDIO)
                != PackageManager.PERMISSION_GRANTED) {

//            // Should we show an explanation?
//            if (ActivityCompat.shouldShowRequestPermissionRationale(Floating2DSearch.this,
//                    Manifest.permission.RECORD_AUDIO)) {
//
...
//            } else {
                ...
                ActivityCompat.requestPermissions(Floating2DSearch.this,
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_READ: {
                ...
                if (grantResults.length > 0
                    ...
                    Intent id = new Intent(Floating2DSearch.this,
...
//                    String url= playlistItem + MyAcessTokenData + and + part + and + max + and + playlistId + idForList +and+key+and+"mine=true"+and+pageToken + pages.get(page);
                    String url= "-";
                    try {
                        url = searchUrl + and + part + and + type+and+ pageToken + pages.get(0) + and + max + and + term + URLEncoder.encode(searchQuery, "UTF-8") + and + MyAcessTokenData + and+key;
...
//                            .setCategory("Audio")
//                            .setAction("Listening for audio 2D")
...
//                                        textMatchList));
                ...
                String url= playlistItem + MyAcessTokenData + and + part + and + max + and + playlistId + idForList +and+key+and+"mine=true"+and+pageToken + pages.get(page);
                try {
                    url = searchUrl + and + part + and + type+and+ pageToken + pages.get(0) + and + max + and + term + URLEncoder.encode("so you think you can dance", "UTF-8") + and + MyAcessTokenData + and+key;
                } catch (UnsupportedEncodingException e) {
                    e.printStackTrace();
                }
                //System,out.println(url);
...
//            searchQuery = textMatchList.get(0);
            ...
            String url= playlistItem + MyAcessTokenData + and + part + and + max + and + playlistId + idForList +and+key+and+"mine=true"+and+pageToken + pages.get(page);
            try {
                url = searchUrl + and + part + and + type+and+ pageToken + pages.get(0) + and + max + and + term + URLEncoder.encode("magic tricks america's got talent", "UTF-8") + and + MyAcessTokenData + and+key;
            } catch (UnsupportedEncodingException e) {
                e.printStackTrace();
            }
            //System,out.println(url);
...
//    private Tracker mTracker;
    ...
    protected void onResume() {
        super.onResume();
//       mTracker.setScreenName("2D Search");
...
//
//        // Specify the call           Show in Explorer
       // ing package to identify your application
            ...
            try {
                ...
                for (int i = 0; i < max; i++) {
                    ...
                    if (kind.equals("youtube#video")) {
                        ...
                        idsInt.add(0);
                        ids.add(id);
                        myData.add(new data(imageUrl, title, channeltitle,0,Floating2DSearch.this, id));
...
//                for (int i=0; i<stat.myDataAll.size(); i++)
            ...
            {
                page+=1;
                Intent id = new Intent(Floating2DSearch.this, Floating2DVideos.class);
